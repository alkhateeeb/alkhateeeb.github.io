...
const PRODUCTS = [
  {
    ...
    description:
      "Harvested from the pristine highland meadows of northern Jordan above 1,200 m elevation. This raw wildflower honey captures the complex floral symphony of dozens of mountain wildflowers — wild thyme, oregano, sage, rock rose, and scores of seasonal blooms — in a single golden jar. Each batch is unique to its season.",
    descriptionAr:
      "يُحصد من المراعي الجبلية. يجمع هذا العسل الخام بين تناسق زهري معقد من عشرات الأزهار البرية الجبلية — الزعتر البري والفجيل ونبتة السليح — في جرة ذهبية واحدة. كل دفعة فريدة من نوعها.",
    source: "Mountain Wild Flora Mix",
    sourceAr: "خليط زهور جبلية برية",
    sourceDesc: "Diverse seasonal wildflowers — Ajloun & Irbid highlands, northern Jordan",
    sourceDescAr: "أزهار برية موسمية متنوعة — مرتفعات عجلون وإربد، شمال الأردن",
    /* Main flower responsible for flavour profile */
    mainFlower:      "Wild Thyme (Thymus serpyllum)",
    mainFlowerAr:    "الزعتر البري",
    mainFlowerEmoji: "🌿",
  ...
  {
    id: 2,
    name: "Centaurea Honey",
    nameAr: "عسل المرار",
    tagline: "Single-Source · Delicate · Therapeutic",
    taglineAr: "مصدر واحد نكهة مميزة جدا · علاجي",
    description:
      "Single-source honey from the purple centaurea (cornflower) blossoms that carpet the Jordanian highlands in late spring. Renowned for its exceptionally light, almost crystalline colour, subtle floral sweetness, and well-documented anti-inflammatory properties. A true connoisseur's honey.",
    descriptionAr:
    ...
    source: "Centaurea (Cornflower) — Centaurea damascena",
    sourceAr: "القنطريون — Centaurea damascena",
    sourceDesc: "Purple centaurea blossoms, highland meadows of Irbid Governorate",
    sourceDescAr: "أزهار المرار الصفراء، مراعي مرتفعات إربد",
    mainFlower:      "Centaurea / Cornflower (Centaurea damascena)",
  ...
  },
  {
    ...
    descriptionAr:
      "عسل غني وجريء يُحصد من بساتين الكافور في سفوح الأغوار. يحمل طابعاً عشبياً مميزاً مع لمسة منثولية خفيفة ولون عنبري دافئ. يُستخدم تقليدياً علاجاً طبيعياً لدعم صحة الجهاز التنفسي والمناعة. نكهة قوية وعطر لا يُنسى.",
    source: "Eucalyptus Tree — Eucalyptus camaldulensis",
    sourceAr: "شجرة الكافور — Eucalyptus camaldulensis",
    sourceDesc: "Eucalyptus groves along the Jordan Valley foothills",
    sourceDescAr: "بساتين الكافور على طول سفوح وادي الأردن",
    mainFlower:      "Eucalyptus Blossom (Eucalyptus camaldulensis)",
    mainFlowerAr:    "زهرة الكينا (الكافور)",
    mainFlowerEmoji: "🌿",
    crystallization:   "slow",
    crystallizationAr: "يتبلور ببطء",
    sourcePlantEmoji: "🌿",
  ...
  },
  {
    ...
    descriptionAr:
      "جوهرة العسل الأردني — يُحصد من شجرة السدر القديمة (Ziziphus spina-christi) المُبجَّلة منذ فجر التاريخ والمذكورة في النصوص المقدسة. ثري ومعقد وعطره بالغ العمق، بلون عنبري داكن وقوام كثيف مخملي. نادر الوجود ومطلوب عالمياً.",
    source: "Sidr / Christ's Thorn Jujube — Ziziphus spina-christi",
    sourceAr: "السدر / نبق المسيح — Ziziphus spina-christi",
    sourceDesc: "Ancient sidr trees in southern Jordan's Wadi Araba & Aqaba region",
    sourceDescAr: "أشجار السدر العريقة في وادي عربة ومنطقة العقبة، جنوب الأردن",
    mainFlower:      "Sidr / Christ's Thorn Jujube (Ziziphus spina-christi)",
    mainFlowerAr:    "شجرة السدر (نبق المسيح)",
    mainFlowerEmoji: "🌳",
    crystallization:   "never",
    crystallizationAr: "لا يتبلور",
    sourcePlantEmoji: "🌳",
